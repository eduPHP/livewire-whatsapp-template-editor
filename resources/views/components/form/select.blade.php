...
<select
    {{ $attributes->merge(['class' => 'block w-full rounded-md border px-2.5 py-1.5 text-sm shadow-sm outline-none transition focus:ring-2 bg-white text-neutral-900 dark:bg-neutral-900 dark:text-neutral-100 '.($invalid
